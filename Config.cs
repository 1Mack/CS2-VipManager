...
public class Messages
{
  ...
  public string NoPlayersFound { get; set; } = "{DEFAULT}No players found with the provided name";
  [JsonPropertyName("PlayerNotAvailable")]
  public string PlayerNotAvailable { get; set; } = "{DEFAULT}I didn't find an available player with the provided name";
  [JsonPropertyName("RolesMenu")]
  public string RolesMenu { get; set; } = "{DEFAULT}Your Admin Roles";
}
